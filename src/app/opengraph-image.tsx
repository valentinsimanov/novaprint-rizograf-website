...
export const alt = 'Типография Новапринт — печать в Пензе';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
          ...
          >
            Печать на ризографе и офсетная печать · Тиражи от 100 экземпляров
          </div>
        </div>
        <div
          style={{
